...
const Post: React.FC<PostProps> = ({
  ...
  const [postText, setPostText] = useState("Bad news!!! ");
  ...
  const [postImage, setPostImage] = useState<string | null>("https://oovbajxvkbwocepnqrmx.supabase.co/storage/v1/object/public/test//P1_H_1.jpg");
